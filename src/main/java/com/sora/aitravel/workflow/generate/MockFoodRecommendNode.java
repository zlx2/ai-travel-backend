...
public class MockFoodRecommendNode implements WorkflowNode<GenerateWorkflowContext> {
    ...
    public void execute(GenerateWorkflowContext context) {
        ...
        List<FoodSpotDTO> foodSpots =
                List.of(
                        new FoodSpotDTO(destination + "本地小吃集合", "老城区域", "地方小吃", "适合穿插在步行街区和夜间行程中。"),
                        new FoodSpotDTO(destination + "特色餐厅街区", "核心商圈", "本地菜", "适合安排正餐，选择多且交通方便。"),
                        new FoodSpotDTO(
                                destination + "夜市美食区", "夜间活跃区域", "夜宵", "适合作为晚间自由活动和体验当地生活的补充。"));
