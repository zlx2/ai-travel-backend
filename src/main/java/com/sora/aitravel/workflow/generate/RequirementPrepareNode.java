...
import static com.sora.aitravel.workflow.generate.TripGraphStateKeys.REQUEST;
...
public class RequirementPrepareNode {
    ...
    private void resolve(TravelRequirementDTO r) {
        ...
        var group = regionRoutePresetService.matchGroup(dst);
        if (group != null) {
            int days = r.getDays() != null ? r.getDays() : 3;
            var preset = regionRoutePresetService.selectPreset(group, days, r.getPreferences());
