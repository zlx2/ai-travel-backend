...
/** 路线折线 / 填充多边形 有fillColor值自动闭合为多边形，无fillColor仅展示折线 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Path {
    /** 线条粗细范围2~15，默认5 */
    @Builder.Default private Integer weight = 5;

    /** 线条颜色 0xRRGGBB，默认0x0000FF */
    @Builder.Default private String color = "0x0000FF";

    /** 线条透明度 0~1，默认1.0 */
    @Builder.Default private Double transparency = 1.0;

    /** 填充颜色，赋值则图形闭合为多边形；不传仅折线 */
    private String fillColor;

    /** 填充透明度0~1，仅fillColor存在时生效，默认0.5 */
    @Builder.Default private Double fillTransparency = 0.5;
