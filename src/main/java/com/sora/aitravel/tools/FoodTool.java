 ...
 * 美食饭店推荐 AI Tool。
 *
 * <p>这是给 Spring AI Alibaba 工作流或 Tool Calling 使用的入口。工具类只负责暴露可调用方法，
 * 真实业务逻辑统一委托给 {@link FoodRecommendService}。
 */
@Component
...
public class FoodTool {
    ...
    public FoodRecommendResponse recommendFood(
            @ToolParam(description = "用户原始美食查询，例如：附近的重庆火锅、洪崖洞附近小吃、重庆火锅推荐")
                    String query,
