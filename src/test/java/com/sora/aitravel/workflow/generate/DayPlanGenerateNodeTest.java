...
class DayPlanGenerateNodeTest {
    ...
    void shouldSupplementEnRouteStopForLongRentalDay() throws Exception {
        ...
        skeleton.setStartArea(new AreaAnchorSnapshot(
        ...
        DayDataPackage dataPackage = new DayDataPackage(1, List.of(qiandao), List.of(), List.of(), List.of());
        Object input = dayPlanInput(profile);

        @SuppressWarnings("unchecked")
        List<PoiCandidate> result = (List<PoiCandidate>) invoke(
                node,
    ...
    void shouldRepairLongLegAfterAiSelection() throws Exception {
        ...
        DayDataPackage dataPackage = new DayDataPackage(1, List.of(hangzhou, qiandao), List.of(), List.of(), List.of());
        Object input = dayPlanInput(profile);
    ...
    private Object dayPlanInput(CityProfile profile) throws Exception {
        Class<?> type = Class.forName("com.sora.aitravel.workflow.generate.DayPlanGenerateNode$DayPlanInput");
