...
public class AmapExample {
    ...
    void test() {
        ...
        // 2. POI周边搜索
        System.out.println("\n=== POI周边搜索 ===");
        AmapApiResp<List<Poi>> aroundResult =
                amapService.searchPoiAround("116.473168,39.993015", 5000);
        ...
        // 4. 经纬度转地名
        System.out.println("\n=== 经纬度转地名 ===");
        AmapApiResp<RegeoCode> regeoResult =
                amapService.reGeoCode("116.481488,39.990464", 1000, "all");
        if (regeoResult.isSuccess()) {
            ...
            if (regeo.getPois() != null) {
                regeo.getPois().forEach(poi -> System.out.printf(poi.toString()));
            }
        }
    }
    ...
    void test02() {
        // 5. 驾车路径规划
        System.out.println("\n=== 驾车路径规划 ===");
        AmapApiResp<Route> drivingResult =
                amapService.drivingRoute("116.481028,39.989643", "116.434446,39.90816");
    ...
    void test03() {
        // 6. 公交路径规划
        System.out.println("\n=== 公交路径规划 ===");
        AmapApiResp<Route> transitResult =
                amapService.transitRoute(
                        "116.481028,39.989643", "116.434446,39.90816", "010", "010", 0, 5, 0);
        if (transitResult.isSuccess()) {
            System.out.println(transitResult);
            //            Route route = transitResult.getData();
            //            System.out.printf("起点: %s, 终点: %s%n", route.getOrigin(),
