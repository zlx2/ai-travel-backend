...
class RentalQuoteServiceImplTest {
    ...
    void shouldBuildRecommendedRentalContextWithStoreAndPackages() {
        RentalQuoteServiceImpl service =
                spy(
                        new RentalQuoteServiceImpl(
                                null, null, null, null, null, new FakeRentalStoreService()));
        doReturn(
                        RentalQuotePreviewResponse.builder()
        ...
        RentalContextPreviewResponse response =
                service.previewContext(new RentalContextPreviewRequest(requirement, "杭州萧山国际机场"));
    ...
    private static RentalQuoteOptionDTO quote(Long id, String code, String name, int dailyFeeCent) {
